...
public class Login extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etUser.setNextFocusDownId(R.id.txtPassword);
	...
	public void checkLogin() {
		...
		try {
			...
			String url = nameHost + "checkLoginclaimer.php";
	...
	public void savetoDB() {
		...
		JSONObject c;
		String url = nameHost + "getByMemberIDclaimer.php";
		try {
			c = new JSONObject(okHttp.POST(url, formBody));
